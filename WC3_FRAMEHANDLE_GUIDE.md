...
Buttons and edit boxes can steal keyboard focus. After button clicks, call `unfocus()` or disable/enable the frame for the triggering player if local focus behavior matters.
